...
def visualize_results(
    ...
    liveness_result = "Живой человек" if liveness_score > 0.1 else "Фейк изображение лица"
    cv2.putText(
        frame,
        f"{liveness_result}",
        (box[0][0], box[0][1] - 55),
    ...
    verification_result = "Личность не подтверждена!" if verification_score > 1 else "Здравствуйте, Мухамеджан!"
    cv2.putText(
        frame,
